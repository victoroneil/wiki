Lua RTOS has an integrated editor that allows you to edit files. You can edit a file typing _os.edit("file")_ in the [Lua prompt](./The-Lua-prompt), or typing _edit file_ in the [shell](./The-shell).
