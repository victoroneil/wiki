![](http://git.whitecatboard.org/esp-wrover-kit.jpg)
...
| Display signal | GPIO |
|--------|------|
| MISO<br/>MOSI<br/>CLK<br/>CS<br/>RST<br/>CMD<br/>BCKL* | GPIO25<br/>GPIO23<br/>GPIO19<br/>GPIO22<br/>GPIO18<br/>GPIO21<br/>GPIO5 |
